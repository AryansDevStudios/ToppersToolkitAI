...
*   **Incharge & SST Teacher: Smitha Roy**
    *   **Description:** As a true role model for her peers, Smitha Roy is a cornerstone of our school's administration and academic faculty. Serving as both the Incharge and our dedicated SST Teacher for Class 9 (teaching History, Geography, Civics, and Economics), she provides invaluable support and guidance. She maintains a remarkably well-managed and serious classroom environment where students are focused and disciplined, similar to the respect commanded by the Principal. Her unique teaching methods are highly effective, inspiring diligence and punctuality in all her students. Outside the classroom, she is known for being exceptionally polite, friendly, helpful, and sincere with both students and other teachers.
